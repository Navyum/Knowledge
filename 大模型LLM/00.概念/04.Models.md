...
* ViT 将图像拆分为一系列图像补丁嵌入与位置编码混合，并将它们馈送到 Transformer 编码器中。ViT 有一个分类头 （MLP - 多层感知），它产生最终的预测
  ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/3f10b60a7e8a4b98fece3f16f2e3a2f9.png)
* 注意力可视化
...
* Swin Transformer 从小尺寸的补丁开始，逐渐将相邻的补丁合并到更深的 Transformer 层中，从而构建分层特征图
  ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/883ed585110507bf48ceeb0738167620.png)
...
* MSA 代表多头自我注意：
  ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/a286804e56372a6dfbfab218d6e72ee3.png)
...
* OpenAI 的 CLIP 模型同时训练图像编码器和文本编码器，以准确预测共享嵌入空间内（图像、文本）的正确配对，从而弥合视觉理解和自然语言理解之间的差距
  ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/d1aae62fffba675c9dfd2a78a5fcbe0e.png)
...
* 有向概率模型，即贝叶斯网络。利用有向无环图 （DAG） 来说明各种随机变量之间的关系和依赖关系。
  ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/c911644e66069245662d3ef9306df276.png)
  ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/de3b3d6189e8e5f7560596c5170f317e.png)
* 说明：
...
* 引入新的注意力机制：
    ...
    * Longfomer 不是完全的全局注意力，而是使用不同注意力模式的组合
        * Sliding Window Attention 推拉窗注意事项
          ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/faf9abfce6195ac5af65fcf80e8b8c60.png)
        * Dilated Sliding Window 扩张推拉窗
          ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/178be1055d3e8738db9928eab11f80fa.png)

        * Global + Sliding Window 全局+ 滑动窗口
          ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/dec3a6bdcef0f15c7568955e11bcc45b.png)
        ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/c4eda387c3aea582adba642da6a3900f.png)
