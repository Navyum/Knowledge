...
## Transformer 整体结构
* 添加了补充信息（手动修改版）：
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/4c3e702e3e84a73026ad2f2ab2087d3d.png)
...
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/19fea58ccb49107196f134bc4e35b089.png)
...
* 公式： x = 单词 Embedding + 位置 Embedding
  ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/7e4d155f93d645df0fa24952d94fa18d.png)
...
* 假设我们有一个模型，将英语句子$X$翻译成法语句子$Y$
    * $X$的第一个词向量一般是$BOS$/$SOS$标记，该模型需要从输入句子 $X$ 中为输出句子 $Y$ 中的第一个词向量 $y1$ 提取上下文 
      ...
      $$
    * 对于$Q$:
        * 假设：$y_1$是输出句子$Y$的第一个元素，本身是四个维度的向量![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/be1793bfe74e2373fde04d90b554137e.png)
        * 假设：$Q$的权重矩阵为$W^Q$，![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/5a3ab67c2ef020afa21d53a2c2ae91d9.png)
        * 对$y_1$进行$W^Q$点积计算$q_1 = y_1 \cdot W^Q$，计算$y_1$在注意力计算中的查询需求：![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/f97388e20c98d58cbf6afc903d817459.png)
        * 对于其他q值
          $$ Q = \begin{bmatrix}
                \boldsymbol{q}_1 \\
                \boldsymbol{q}_2 \\
    ...
    * 对于$K$:
        ...
        * 假设：$K$的权重矩阵为$W^K$
        * 对$x_1$进行$W^K$点积计算$k_1 = x_1 \cdot W^K$，计算$x_1$在注意力计算中的查询需求![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/17a7196917f5347aee40be8381bf1579.png)
        * 对于其他k值
          $$
          K = \begin{bmatrix}
            \boldsymbol{k}_1 \\
...
结构示意图：
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/0ee9b4498e271403002a700d767d4f5f.png)
计算过程图：
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/392f6cc206b26013f4d85e924812c904.png)
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/ff89d34afb9474041d5d2908c815d0b8.png)
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/ef72aa4b3db0b54c5800d93cd0f21d05.png)
...
结构示意图：
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/ff13402258673dd3ab171400e01e8c4a.png)
计算示意图：
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/5312a68962d60c9f54bb0e1ec8e784aa.png)
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/00ee0bbd4935869cefb44c098518a433.png)
...
* 残差连接公式：![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/5bbee0d3908a62831dbe4f9a08f2e807.png)
...
* Mask预测过程：
    * 对$QK^{\mathrm{T}}$的结果应用Mask矩阵转换
      ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/8e7c10689439156e04e4a9a349be3600.png)
