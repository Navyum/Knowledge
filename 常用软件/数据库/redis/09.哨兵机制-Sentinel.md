...
* 选主
* 通知
<img src="https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/3c68cf3a79e2a87c85df1da33dbae137.png" width =60% >
#### 监控：
* 通信机制：
...
<img src="https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/d348f7a50bf7283ec95282087db3e6af.png" width =60% >
...
* 选主规则：`过滤+打分`
    ...
    2. `打分`优先级：
        ...
        3. 从库ID号，越小越靠前（`runID`）
    <img src="https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/ce8d4ab27b39f1a928abadc87acf6e93.png" width =60% >
...
* 获取集群内所有从库信息（IP）：
    ...
    * 主库返回`从库列表`
    <img src="https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/48e898daa482c4c2344a113fc5ceeee3.png" width =60% >

#### 3. 通知客户端主库变更：
* `哨兵集群`将新主库的信息（IP等）通知给客户端
* 哨兵和客户端通信：`发布/订阅机制`：
    * 每个`哨兵节点`提供`发布者/订阅者机制`，客户端可以从哨兵订阅消息，关注主、从故障转移中的关键事件
<img src="https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/9dd8582a2a13ab80f9e61b0a57c0dfab.png" width =60% >
