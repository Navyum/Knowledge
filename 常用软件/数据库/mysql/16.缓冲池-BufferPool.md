...
#### 结构：
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/058365e2e09ca5c1ed90474ef1e3647c.png)
* 基本构成：
    * 控制块：
...
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/8ee379a0fadd87c2430b800416d4a074.png)


#### 管理脏页：
* 如何查找脏页并写入磁盘？
* 在需要刷盘时，使用`Flush链表`，后台线程就可以遍历`脏页`，写入到磁盘
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/29f0c6de27a31c1717187cea069ebb5e.png)
* `脏页刷盘时机`：
...
- 缓存相关的问题
    1. 避免预读导致的缓存失效
        ...
        - 具体方法：
            ...
            ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/66ffc5b4042bc71b3fdbe58e1149359d.png)
    2. 避免Buffer Pool污染
...
* 多实例解决了锁的粒度问题
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/2b588bf4eb6713a507d8f0f8c936a467.png)
...
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/e1f6a913309313f42824eac7f7504980.png)
