...
### Compact 行记录结构：
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/9b2478b80165fe95ae801cd4d5982c04.png)
- `记录的额外信息`
    - `变长字段长度列表`
        - 图示：
          ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/1ec8fea4a6afa3a70d2f1bf8276e00db.png)
        - 变长字段的定义：
            - `VARCHAR(M)`
    ...
    - `记录头信息`
        - 图示：
          ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/4b3c4c56bb5c16800c29412c82d72b87.png)
        - 结构如下：
        - |名称|大小（单位：bit）|描述|
        |:--:|:--:|:--:|
        |`预留位1`|`1`|没有使用|
...
- `记录的真实数据`
    - `隐藏列`
        - 图示：
          ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/b17a9f8ef15bd2165fff4b7aee1cf216.png)
        - 结构如下：
        - |列名|是否必须|占用空间|描述|
        |:--:|:--:|:--:|:--:|
...
### Redundant 行格式：
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/8cb1f0df47d5a63210c00b3e5941f2e9.png)
...
- VARCHAR(M)理论存储的字符数量：
    ...
    - ASCII编码, M的最大值：
        ...
        - VARCHAR(M) 没有定义NOT NULL, M最多为65532 = (65535-2-1)/1
            ...
            - ASCII每个字符需要1个字节
    - 不同编码下的M最大值：
      ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/d386014556933b4aac7822842ea0304c.png)
...
- `行溢出`：`单个记录`数据超过页的大小限制：
    ...
    - 行记录格式针对`行溢出`的方案：
        ...
        - `Compact`、`Reduntant` 行溢出：
          ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/6c44d94914129346c74045ec6ef2fc35.png)
        - `Dynamic`、`Compressed` 行溢出：
          ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/ca704c255cdaab31f93fb7d58d2cbb05.png)
    - `行溢出的临界点`计算：
