...
## 区（extent）示意图：
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/f88ce3d405ad9091febc7f1c472309bb.png)

## FSP_HDR 类型页（特殊的XDES类型页）：
第一个组的第一个页，当然也是表空间的第一个页，页号为`0`。这个页的类型是`FSP_HDR`，它存储了表空间的整体属性以及第一个组内256个区的对应的`XDES Entry`结构 
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/37bbfb5686165201ab5ca5bfa9f9da85.png)

### File Space Header：
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/c0515d2bbf029c1e1183995fdd28ab95.png)
...
### XDES Entry：用来记录区的属性
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/f2479364e5d8a7ed82735565efb72ca9.png)
...
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/831c94cf44bf2a6afac07e8079351cca.png)

### INODE Entry（段结构）：用来记录段的属性
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/d752dd37914c98c46af67226ea28fbef.png)
...
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/94eee7992de378b138b121ece2576d7a.png)
...
## 汇总：
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/cd131c68727df1ab80a39b0c25de837b.png)
