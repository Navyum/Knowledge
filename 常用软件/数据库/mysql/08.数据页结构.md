...
### 数据页的详细结构：
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/f1ccac71f2562f6a1e904a67c0a34d51.png)
数据页组成：
|名称|中文名|占用空间大小|简单描述|
|:----|:----|:----|:----|
...
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/4499ff2280bc5433c2808a34a47435b7.png)
...
* 本页中主键值最大的用户记录的下一条记录就是 Supremum记录（也就是最大记录）
  ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/967bb4d83797d8e3ad995d2057f3ae62.png)
...
* next_record：
    ...
    * 本页中Infimum记录（也就是最小记录）的下一条记录就是本页中主键值最小的用户记录
    * 本页中主键值最大的用户记录的下一条记录就是 Supremum记录（也就是最大记录）
    ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/b1f83f15e0501bdc3559c41d535d4423.png)
* 删除和重用空间
...
- 作用：通过页目录中槽内的值，可以在页内快速找到目标记录所在的分组，然后从对应分组内最小记录遍历即可（这样就不需要遍历页内的所有记录）
    ...
    - 槽中的数据是顺序排放的
    ![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/b8024de34930678a090fa1759d97d548.png)
- 页目录的分组规则：
    * 最小记录(infimun)独立为1组
