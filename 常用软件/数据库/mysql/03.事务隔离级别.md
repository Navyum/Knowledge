...
### 事务的状态机：
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/0731afc4e43cad83d232b2288fc7f617.png)
...
### 关于隔离级别的例子：
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/e6ecdc4a33cca95933dd3c9297c3d922.png)
...
### Undo log：
举个例子：
![图片](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/19ca945285325f47a4f18afff70a1172.png)
...
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/3a41b1249a0dbf94211f925119fd9233.png)

3. 结合undo log 如下：
![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/e366827a5a711a60898c2c1fa7934661.png)
...
13. `next-key lock`：间隙锁+记录锁，解决`RR隔离级别`下，使用`当前读`时的幻读问题
    ...
    ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/2915add2219a64344c7c03b7ab465176.png)
14. 插入意向锁：
15. 无法避免的幻读：
    1. 事务A先使用快照读，事务B插入/删除记录，事务A使用当前读，则会发生幻读
    ![Img](https://cdn.jsdelivr.net/gh/Navyum/imgbed@pic/IMG/d3058b229ca766151727fc4d91b659ef.png)
    2. 从业务上避免的措施：
